# ========== CONFIG ==========
MODEL_NAME = "dispatch_M4"           # Short identifier for model
NUM_AMBULANCES = 4
...
def main():
    ...
    env = DummyVecEnv([lambda: Monitor(SimpleDispatchEnv(sim, max_steps=100_000, verbose=False))])
    env = VecNormalize(env, norm_obs=True, norm_reward=False, clip_obs=10.0)

    model = PPO("MultiInputPolicy", env, verbose=1, tensorboard_log=str(LOG_DIR), **LEARNING_PARAMS)
